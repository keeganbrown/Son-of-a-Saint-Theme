	...
	class BootstrapBasicSearchWidget extends WP_Widget
	{
		...
		public function __construct()
		{
			parent::__construct(
					...
					__('Bootstrap Navbar Search', 'son-of-a-saint'), 
					array('description' => __('Display Search widget for Bootstrap navbar.', 'son-of-a-saint'))
			);
		}// __construct
		...
		public function form($instance) 
		{
			...
			// output form
			$output = '<p>';
			$output .= '<label for="' . $this->get_field_id('navbaralign') . '">' . __('Form alignment:', 'son-of-a-saint') . '</label>';
			$output .= '<select id="' . $this->get_field_id('navbaralign') . '" name="' . $this->get_field_name('navbaralign') . '">';
			$output .= '<option value="navbar-left"' . ($navbaralign == 'navbar-left' ? ' selected="selected"' : '') . '>' . __('Left', 'son-of-a-saint') . '</option>';
			$output .= '<option value="navbar-right"' . ($navbaralign == 'navbar-right' ? ' selected="selected"' : '') . '>' . __('Right', 'son-of-a-saint') . '</option>';
			$output .= '</select>';
			$output .= '</p>';
