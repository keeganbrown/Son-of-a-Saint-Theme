...
if (!function_exists('bootstrapBasicSetup')) {
	...
	function bootstrapBasicSetup() 
	{
		...
		register_nav_menus(array(
			'primary' => __('Primary Menu', 'son-of-a-saint'),
		));
...
if (!function_exists('bootstrapBasicWidgetsInit')) {
	...
	function bootstrapBasicWidgetsInit() 
	{
		...
		register_sidebar(array(
			'name'          => __('Navigation bar right', 'son-of-a-saint'),
			'id'            => 'navbar-right',
			'before_widget' => '',
			'after_widget'  => '',
			'before_title'  => '',
		...
		register_sidebar(array(
			'name'          => __('Sidebar left', 'son-of-a-saint'),
			'id'            => 'sidebar-left',
		...
		register_sidebar(array(
			'name'          => __('Sidebar right', 'son-of-a-saint'),
			'id'            => 'sidebar-right',
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h1 class="widget-title">',
		...
		register_sidebar(array(
			'name'          => __('Footer left', 'son-of-a-saint'),
			'id'            => 'footer-left',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h1 class="widget-title">',
		...
		register_sidebar(array(
			'name'          => __('Footer right', 'son-of-a-saint'),
			'id'            => 'footer-right',
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h1 class="widget-title">',
